...
const projects = [
  {
    ...
    description:
      "Full-stack career and placement-preparation platform designed to help students organize company research, DSA preparation, interviews, and projects in one place.",
    stack: [
      "React",
      "Node.js",
      "Express.js",
  ...
  },
  {
    ...
    description:
      "Full-stack e-commerce application implementing authentication, product browsing, search and filtering, cart management, pricing calculations, and database-backed product data.",
    stack: [
      "Node.js",
      "Express.js",
      "MongoDB",
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-1 text-neutral-400 transition hover:text-white"
            >
              Live Demo
        ...
        <div className="mt-6">
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            {project.architecture.map((layer, layerIndex) => (
              <div key={layer}>
                <span className="rounded-md border border-white/10 bg-white/5 px-3 py-2 text-sm text-neutral-300">
                  {layer}
                </span>
    ...
    <section id="projects" className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-4 max-w-2xl text-neutral-400">
          Selected full-stack applications built to solve practical problems and
