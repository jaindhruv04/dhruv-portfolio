const experience = [
  {
    ...
    date: "Present",
    description:
      "Co-founded a student society focused on Artificial Intelligence, Machine Learning, and Generative AI. Working on establishing technical workshops, hackathons, and project-building sessions for students.",
  },
  {
    type: "Leadership",
          ...
          {experience.map((item) => (
            ...
            >
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="rounded-full border border-white/10 px-2.5 py-1 text-xs text-neutral-500">
                  {item.type}
                </span>
              </div>
